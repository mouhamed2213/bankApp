                ...
                <div class="bg-white shadow-lg rounded-xl overflow-hidden">
                    <form method="POST" action="{{ route('transaction.withdraw.store') }}">
                        ...
                        <div class="p-6 sm:p-8">
                            <h3 class="text-lg font-semibold text-gray-800 mb-1">Détails du retrait</h3>
                            <p class="text-sm text-gray-500 mb-6">Choisissez le compte à débiter et le montant du retrait.</p>
                            ...
                            <div class="space-y-6">
                                ...
                                <!-- Montant à retirer -->
                                <div>
                                    <label for="withdraw" class="block text-sm font-medium text-gray-700">Montant à retirer (FCFA)</label>
